import AdminSideNavLinks from '@/components/Admin/AdminNavbar/AdminSideNavLinks'
        ...
        <>
            <section
                ...
                <div className='h-screen' >
                    <div className='bg-white w-full z-[1036] fixed p-4 shadow-[0_4px_12px_0_rgba(0,0,0,0.07),_0_2px_4px_rgba(0,0,0,0.05)]'>
                        <button
                    ...
                    <div className='pt-20'><span className='pt-60'>check 234</span></div>
                </div>
            </section>
        </>
    )
