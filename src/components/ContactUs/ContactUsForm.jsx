...
const ContactUsForm = () => {
  ...
  const onSubmit = (data) => {
    setSubmitting(true)
    postContactUsApi({ data, reset, setSubmitting })
  }; // your form submit function which will invoke after successful validation

  watch("example"); // you can watch individual input by pass the name of the input
    ...
    <div class="block xs:w-max rounded-lg bg-white p-6 shadow-lg">
      <form onSubmit={handleSubmit(onSubmit)}>
        <div class="relative mb-6 w-80" data-te-input-wrapper-init="">
          ...
          <label
            for="exampleInput7"
            class="pointer-events-none absolute top-0 left-3 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[1.6] text-neutral-500 transition-all duration-200 ease-out peer-focus:-translate-y-[0.9rem] peer-focus:scale-[0.8] peer-focus:text-primary peer-data-[te-input-state-active]:-translate-y-[0.9rem] peer-data-[te-input-state-active]:scale-[0.8] motion-reduce:transition-none dark:text-black dark:peer-focus:text-dark ml-0"
          >
            Name
          </label>
          <div
        ...
        <div class="relative mb-6" data-te-input-wrapper-init>
          ...
          <label
            ...
            class="pointer-events-none absolute top-0 left-3 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[1.6] text-neutral-500 transition-all duration-200 ease-out peer-focus:-translate-y-[0.9rem] peer-focus:scale-[0.8] peer-focus:text-primary peer-data-[te-input-state-active]:-translate-y-[0.9rem] peer-data-[te-input-state-active]:scale-[0.8] motion-reduce:transition-none dark:text-black dark:peer-focus:text-primary"
          >
            Message
          </label>
        </div>
        ...
        <button
          type="submit"
          class="w-full rounded bg-primary px-6 py-2.5 text-xs font-semibold uppercase leading-tight text-white shadow-md transition duration-150 ease-in-out hover:bg-primary-700 hover:shadow-lg focus:bg-primary-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-primary-800 active:shadow-lg"
          data-te-ripple-init
        ...
        >
          {
            submitting ? <>
              <svg class="animate-spin  w-5 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
