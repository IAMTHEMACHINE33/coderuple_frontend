const Footer = () => {
  return (
    <footer className="bottom-0 mt-52 p-5 left-0 z-20 w-full bg-white  md:flex md:items-center md:justify-between md:p-6">
      ...
      <ul className="flex flex-row flex-nowrap  items-center font-semibold lg:text-lg lg:mr-20  mt-0 sm:dark:text-black-400 text-xs max-w-full justify-center mb-0 sm:mr-0">
        <li>
