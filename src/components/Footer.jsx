      ...
      <footer className="responsive-container  md:mt-72 bottom-0 p-5 left-0 z-20  bg-white  md:flex md:items-center md:justify-between md:p-6">
        <span className="grid grid-rows-3 grid-flow-col gap-0.5 justify-center text-center ">
          ...
          <div className="grid grid-cols-4 gap-2 justify-center">
            ...
            <div>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 10 730 730">
        ...
        <ul className="text-center flex flex-row flex-nowrap gap-3 sm:gap-5  items-center font-semibold lg:text-lg   mt-0 sm:dark:text-black-400 text-xs max-w-full justify-center mb-0 sm:mr-0">
          <li>
