            ...
            <div className='responsive-container flex flex-col  py-20 gap-6'>
                ...
                <div className='flex flex-col gap-4 text-center items-left '>
                    <div className='flex md:flex-row-reverse flex-col items-center'>
                        <Image src={company} className='h-60 w-auto md:w-1/2 rounded-md ' alt="image" ></Image>
                        <div className=' font-light md:w-1/2 text-left flex flex-col gap-5 px-5 md:px-0 items-center md:items-start'>
