            ...
            <div className=' flex  justify-center responsive-container'>
                ...
                <div className='py-20 flex flex-col gap-10 w-full '>
                    ...
                    <div className='flex flex-col lg:flex-row  gap-8'>
                        ...
                        content={"At our company, we collaborate as a team to bring our clients' unique web application design ideas to life. Our goal is to deliver a customised solution that meets their needs and exceeds their expectations."}
                        />
                        <Cardservice
