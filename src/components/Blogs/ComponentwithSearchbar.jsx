  ...
  return (
    <div className="relative">
      ...
      <div className="relative flex justify-center z-0 bg-[#D9D9D9]">
        <div className="relative responsive-container flex justify-start items-start py-20 gap-10 ">

          <div className='w-1/2 flex flex-col gap-10'>
            <BlogComponent />
            <BlogComponent />
          </div>
          <div className="sticky right-24 z-50 w-[500px] flex flex-col gap-8 top-20 pt-10">
