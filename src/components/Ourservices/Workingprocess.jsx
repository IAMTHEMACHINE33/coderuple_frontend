            ...
            <div className='responsive-container flex flex-col py-20 gap-10'>
                ...
                <div className='flex flex-row gap-16'>
                    <div className='flex flex-col items-center gap-12 w-48'>
                        ...
                        <div className='flex flex-col items-center gap-6'>
                            <div className='bg-[#D9D9D9] h-12 w-12 rounded-full flex justify-center items-center'>
                                <span className='bg-[#E7E7E7]  h-10 w-10 rounded-full flex justify-center items-center font-bold'>1</span>
                            </div>
                    ...
                    <div className='flex flex-col items-center gap-12 w-52'>
                        ...
                        <div className='flex flex-col items-center gap-6'>
                            <div className='bg-[#D9D9D9] h-12 w-12 rounded-full flex justify-center items-center'>
                                <span className='bg-[#E7E7E7]  h-10 w-10 rounded-full flex justify-center items-center font-bold'>2</span>
                            </div>
                            <h1 className=' capitalize text-4xl font-normal'>
                                PLANNING
                            </h1>
                    ...
                    <div className='flex flex-col items-center gap-12 w-52'>
                        ...
                        <div className='flex flex-col items-center gap-6'>
                            <div className='bg-[#D9D9D9] h-12 w-12 rounded-full flex justify-center items-center'>
                                <span className='bg-[#E7E7E7]  h-10 w-10 rounded-full flex justify-center items-center font-bold'>3</span>
                            </div>
                            <h1 className=' capitalize text-4xl font-normal'>
                                EXECUTE
                            </h1>
                    ...
                    <div className='flex flex-col items-center gap-12 w-52'>
                        ...
                        <div className='flex flex-col items-center gap-6'>
                            <div className='bg-[#D9D9D9] h-12 w-12 rounded-full flex justify-center items-center'>
                                <span className='bg-[#E7E7E7]  h-10 w-10 rounded-full flex justify-center items-center font-bold'>4</span>
                            </div>
                            <h1 className=' capitalize text-4xl font-normal'>
                                DELIVER
                            </h1>
