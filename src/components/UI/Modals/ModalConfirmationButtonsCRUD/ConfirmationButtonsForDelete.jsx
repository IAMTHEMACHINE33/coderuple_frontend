...
const ConfirmationButtonsForDelete = (props) => {
  ...
  return (
    <div
      ...
      <TailwindButton button_type="danger" button_target={`${props.id}`} handleClick={handleClick} willNotDismissModal={true} disabled={isLoading}>
        {
          isLoading ? <div className="mx-3"><CircleSpinner /></div> : <>Delete</>
        }
      </TailwindButton>
    </div>
  )
...
export default ConfirmationButtonsForDelete